...
const authorizedFetch = async (input: FetchInput, init: FetchInit | object): Promise<any> => {
...
export async function getSuggestedForReviewConnections(): Promise<Connection[]> {
  return authorizedFetch(`${baseUrl}/connections`, {
    method: 'GET',
  });
}

export async function connectWithUser(userId: Connection['id']): Promise<Connection> {
  return authorizedFetch(`${baseUrl}/connections/connect/${userId}`, {
    method: 'POST',
  });
}

export async function unconnectWithUser(userId: Connection['id']): Promise<Connection> {
  return authorizedFetch(`${baseUrl}/connections/connect/${userId}`, {
    method: 'DELETE',
  });
}
...
export async function updateReview(reviewId: string, reviewData: SendReviewData): Promise<Review> {
  return authorizedFetch(`${baseUrl}/reviews/${reviewId}`, {
    method: 'PUT',
    body: reviewData,
  });
